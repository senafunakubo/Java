...
//              int[] num = {12, 45, 7, 42, 89, 99, 54, 23, 63, 52, 41, 75, 65, 54, 94, 68, 62, 43, 49, 89, 40, 60, 50, 70, 223, 336, 225};
            ...
            System.out.println("\ntime taken in worst case Bubble sort " + Duration.between(start, end));
            ...
            System.out.println("\ntime taken in avg case Bubble sort " + Duration.between(start, end));
            ...
            System.out.println("\ntime taken in best case Bubble sort " + Duration.between(start, end));
